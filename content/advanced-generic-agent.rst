...
The *Advanced Generic Agent* feature add-on now makes it possible to also assign a time value in the form of a time span instead of a certain point in time, i.e. *+ 2 weeks* or *-3 months*, to the dynamic field. Employees are therefore able to specify resubmission periods or organize recurring communication processes with special customers easily and at regular intervals.
...
.. Original content: https://otrs.com/otrs-feature/feature-add-on-advanced-generic-agent/

.. toctree::
   :maxdepth: 1
   :caption: Contents

   advanced-generic-agent/admin
   advanced-generic-agent/agent
   advanced-generic-agent/external
