...
.. Original content: https://otrs.com/otrs-feature/feature-add-on-escalation-suspend/

.. toctree::
   :maxdepth: 1
   :caption: Contents

   escalation-suspend/admin
   escalation-suspend/agent
   escalation-suspend/external
